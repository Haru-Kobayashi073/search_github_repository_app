...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  late final _StringsSearchRepositoryEn searchRepository =
      _StringsSearchRepositoryEn._(_root);
}
...
class _StringsDrawerEn {
  ...
  late final _StringsDrawerLanguageEn language =
      _StringsDrawerLanguageEn._(_root);
}
...
class _StringsSearchRepositoryEn {
  ...
  // Translations
  late final _StringsSearchRepositoryDetailEn detail =
      _StringsSearchRepositoryDetailEn._(_root);
...
class _StringsJa implements Translations {
  ...
  @override
  late final _StringsAppBarJa appBar = _StringsAppBarJa._(_root);
  @override
  late final _StringsSearchRepositoryJa searchRepository =
      _StringsSearchRepositoryJa._(_root);
}
...
class _StringsDrawerJa implements _StringsDrawerEn {
  ...
  // Translations
  @override
  late final _StringsDrawerThemeJa theme = _StringsDrawerThemeJa._(_root);
  @override
  late final _StringsDrawerLanguageJa language =
      _StringsDrawerLanguageJa._(_root);
}
...
class _StringsAppBarJa implements _StringsAppBarEn {
  ...
  // Translations
  @override
  String get validatorNullCheck => '検索ワードを入力してください';
  @override
  String get hintText => 'どんなリポジトリをお探しですか？';
}
...
class _StringsSearchRepositoryJa implements _StringsSearchRepositoryEn {
  ...
  // Translations
  @override
  late final _StringsSearchRepositoryDetailJa detail =
      _StringsSearchRepositoryDetailJa._(_root);
  @override
  String get empty => 'リポジトリが見つかりませんでした';
  @override
  String get error => 'エラーが発生しました... \n ネットワークを確認してください';
  @override
  String get reload => '再読み込み';
  @override
  String get letsSearch => 'リポジトリを探索してみよう';
  @override
  String foundCount({required Object count}) => '${count} 件の検索結果';
}
...
// Path: searchRepository.detail
class _StringsSearchRepositoryDetailJa
    implements _StringsSearchRepositoryDetailEn {
  ...
  // Translations
  @override
  String star({required Object star}) => '${star} スター';
  @override
  String fork({required Object fork}) => '${fork} フォーク';
  @override
  String watch({required Object watch}) => '${watch} ウォッチ';
  @override
  String issue({required Object issue}) => '${issue} オープン';
  @override
  String get languageEmpty => '言語なし';
}
...
extension on Translations {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      case 'drawer.theme.title':
        return 'theme';
      case 'drawer.theme.system':
        return 'system';
      case 'drawer.theme.light':
        return 'light';
      case 'drawer.theme.dark':
        return 'dark';
      case 'drawer.language.title':
        return 'language';
      case 'drawer.language.ja':
        return 'Japanese';
      case 'drawer.language.en':
        return 'English';
      case 'appBar.validatorNullCheck':
        return 'Please enter search words';
      case 'appBar.hintText':
        return 'What repository are you looking for?';
      case 'searchRepository.detail.star':
        return ({required Object star}) => '${star} start';
      case 'searchRepository.detail.fork':
        return ({required Object fork}) => '${fork} fork';
      case 'searchRepository.detail.watch':
        return ({required Object watch}) => '${watch} watch';
      case 'searchRepository.detail.issue':
        return ({required Object issue}) => '${issue} open issue';
      case 'searchRepository.detail.languageEmpty':
        return 'No language';
      case 'searchRepository.empty':
        return 'Repository could not be found';
      case 'searchRepository.error':
        return 'An error has occurred...  \n Please check your network';
      case 'searchRepository.reload':
        return 'reload';
      case 'searchRepository.letsSearch':
        return 'Let\'s explore the repository!';
      case 'searchRepository.foundCount':
        return ({required Object count}) => '${count} search results';
      default:
        return null;
    }
  }
...
extension on _StringsJa {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'appBar.hintText':
        return 'どんなリポジトリをお探しですか？';
      case 'searchRepository.detail.star':
        return ({required Object star}) => '${star} スター';
      case 'searchRepository.detail.fork':
        return ({required Object fork}) => '${fork} フォーク';
      case 'searchRepository.detail.watch':
        return ({required Object watch}) => '${watch} ウォッチ';
      case 'searchRepository.detail.issue':
        return ({required Object issue}) => '${issue} オープン';
      case 'searchRepository.detail.languageEmpty':
        return '言語なし';
      case 'searchRepository.empty':
      ...
      case 'searchRepository.reload':
        return '再読み込み';
      case 'searchRepository.letsSearch':
        return 'リポジトリを探索してみよう';
      case 'searchRepository.foundCount':
        return ({required Object count}) => '${count} 件の検索結果';
      default:
        return null;
    }
  }
